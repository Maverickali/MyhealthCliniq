...
Route::group(['middleware' => ['auth', 'activated', 'activity', 'twostep']], function () {
    ...
    Route::put('/home/{id}', ['as' => '{id}',   'uses' => 'UserController@update']);
...
Route::group(['middleware' => ['auth', 'activated', 'currentUser', 'activity', 'twostep']], function () {
    ...
    Route::put('profile/{username}/edit', [
        'as'   => '{username}',
    ...
    Route::get('appointments', [
        'uses' => 'AppointmentController@filter',
    ]);
    
    
    Route::get('AppointmentResquest/{id}', [
            'uses' => 'AppointmentController@appoint',
    ]);
