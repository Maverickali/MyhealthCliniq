...
class ProfilesController extends Controller
{
    ...
    public function show($username)
    {
        ...
        }elseif ($this->middleware('role:doctor')){
    ...
    public function update($username, Request $request)
    {
        ...
        //         'theme_id', 
        //         'location', 'bio', 
        //         'medipracticename','yearoflicence',
        //         'placeowork','contactno',
        //         'workemail','medical_licence','avatar_status');
        ...
        //     'occuption', 'nofkin',
        //     'nofkinrelationship','nofkinrelationshipcontact',
        //     'height','weight','locationa','chronicillness','allergies',
        //     'medication_suppliments','bio', 'avatar_status');
